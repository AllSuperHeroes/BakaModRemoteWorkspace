...
public class BakaBlockBlock extends BakamodModElements.ModElement {
	@ObjectHolder("bakamod:baka_block")
	public static final Block block = null;

	public BakaBlockBlock(BakamodModElements instance) {
		super(instance, 1);
	}
